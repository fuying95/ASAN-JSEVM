  ...
  function initHackerContractcall (cb) {
    ...
    if (callcode) {
      if (caller != null) {
        ...
        var nextCall = call.OnCallCode(caller, toAddress, gasPrice, txData, txValue, stateManager)
      ...
      if (caller != null) {
        ...
        var nextCall = call.OnDelegateCall(caller, toAddress, gasPrice, txData, stateManager)
        // nextCall.snapshotId = snapshot ???
        if (nextCall == null) {
          console.log('nextcall is nil')
          cb()
      ...
      if (caller != null) {
        ...
        var nextCall = call.OnCall(caller, toAddress, gasPrice, txData, txValue.toArrayLike(Buffer), stateManager)
        // nextCall.snapshotId = snapshot ???
        if (nextCall == null) {
          console.log('nextcall is nil')
          cb()
